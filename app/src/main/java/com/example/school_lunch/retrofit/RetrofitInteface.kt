...
interface RetrofitInteface {
    ...
    fun ApiService(
            ...
            @Query("KEY") key : String = "67ebdc05dfea4d1dbc9fe76fc5a7932b", // api 인증키, 9e67bf29119b4c5389bec9404585ad45
            ...
            @Query("pIndex") index : Int = 1, // 페이지 위치            |   기본값 : 1(sample key는 1 고정)
            @Query("pSize") size : Int = 100  // 페이지 당 신청 숫자     |  기본값 : 100(sample key는 5 고정)
